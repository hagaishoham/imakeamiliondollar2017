...
const links = [
  { href: "/memory", label: "Memory", icon: "◉", desc: "Active context & threads" },
  { href: "/meetings", label: "Meetings", icon: "◎", desc: "Transcripts & processing" },
  { href: "/settings", label: "Settings", icon: "⚙", desc: "API key & preferences" },
];
